How to install?
1. copy bin files at usr/local/bin/* to /usr/local/bin
   cp -arfp usr/local/bin/* /usr/local/bin/
2. copy vpnse to /usr/local/bin
   cp -arfp vpnse /usr/local/bin/

You can run vpnse now.
===============================================
Usage: vpnse conncect/start/status/disconnect/stop/add/del account_name
  e.g. vpnse conn van2869
